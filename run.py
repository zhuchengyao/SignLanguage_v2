...
COMMAND_MODULES = {
    ...
    "train-vae": "src.commands.train.vae",
    "train-latent-flow": "src.commands.train.latent_flow",
    "train-dual-vae": "src.commands.train.dual_vae",
    "train-dual-flow": "src.commands.train.dual_flow",
    "infer-t2m": "src.commands.infer.t2m",
    "infer-flow2d-text": "src.commands.infer.flow2d_text",
    "infer-vae-flow": "src.commands.infer.vae_flow",
    "infer-dual-flow": "src.commands.infer.dual_vae_flow",
    "eval-vqvae": "src.commands.eval.vqvae",
    "eval-vae": "src.commands.eval.vae",
