...
class HLC_NAR_Config:
    def __init__(self):
        ...
        # --- HLC Encoder Architecture (4090-24GB, leak-free) ---
        self.hlc_d_model = 512
        self.hlc_nhead = 8
        self.hlc_num_layers = 6
        self.hlc_dim_ff = 2048
        self.hlc_dropout = 0.1

        # --- HLC Codebook ---
        self.global_codebook_size = 1024
        self.local_codebook_size = 2048
        self.vq_embedding_dim = 512
        ...
        self.nar_nhead = 8
        self.nar_num_layers = 8
        self.nar_dim_ff = 2048
        self.nar_dropout = 0.1
        self.nar_input_dim = 2048  # 4 codebooks * 512

        # --- Token Predictor ---
        self.tok_pred_layers = 6
        self.tok_pred_nhead = 8
        self.tok_pred_dim_ff = 2048
        self.tok_pred_dropout = 0.1

        # --- Length Predictor ---
        self.len_pred_hidden = 512
        self.max_target_len = 200

        # --- RTP (Rhythm-Tempered Phase) ---
        self.rtp_hidden_dim = 512
        self.rtp_nhead = 8
        self.rtp_num_layers = 3
        self.rtp_alpha = 0.5
        ...
        self.stage1_lr = 3e-4
        self.stage1_batch_size = 48
        self.stage1_val_batch_size = 24

        # --- Stage 2: RTP Alignment ---
        self.stage2_epochs = 15
        self.stage2_lr = 1e-4
        self.stage2_batch_size = 40
        self.stage2_val_batch_size = 20

        # --- Stage 3: Joint Fine-tuning ---
        self.stage3_epochs = 15
        self.stage3_lr = 5e-5
        self.stage3_batch_size = 32
        self.stage3_val_batch_size = 16

        # --- DataLoader (4090 w/ fast NVMe) ---
        self.num_workers = 4
